...
('Hall A', 30, '{"rows":6, "columns":5}'),
('Hall B', 48, '{"rows":8, "columns":6}'),
('Hall C', 35, '{"rows":7, "columns":5}');
...
-- 用户通过订单 10 对座位 H1_A1 打 8 分
INSERT INTO seat_experience_ratings (seat_id, order_id, rating)
VALUES ('H1_A1', 1, 8);

-- 用户通过订单 10 对座位 H1_A2 打 9 分
INSERT INTO seat_experience_ratings (seat_id, order_id, rating)
VALUES ('H1_A2', 1, 9);

-- 用户通过订单 11 对座位 H1_A1 再打 7 分（不同订单允许）
INSERT INTO seat_experience_ratings (seat_id, order_id, rating)
VALUES ('H1_A1', 3, 7);

-- 用户通过订单 12 对座位 H2_B1 打 10 分
INSERT INTO seat_experience_ratings (seat_id, order_id, rating)
VALUES ('H2_B1', 2, 10);
